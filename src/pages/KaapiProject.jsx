...
import icon from "../assets/icon.svg"; // ✅ Update this path to your actual icon

// ✅ Inline ColorBox component — no external import needed
...
function KaapiProject() {
  return (
    <section className="w-full px-6 sm:px-8 md:px-[20px] lg:px-[100px]  py-16 bg-white max-w-[1600px] mx-auto">
